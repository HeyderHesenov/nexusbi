...
export function UploadSourceModal({ open, onClose }: Props) {
  ...
  return (
    <ModalShell
      open={open}
      onClose={onClose}
      title="CSV / Excel yüklə"
      subtitle="Faylı yüklə, NexusBI onu sorğulana bilən cədvələ çevirir."
      footer={
      ...
      <div className="space-y-3 p-5">
        ...
        >
          ...
          <span className="text-sm text-ink">
            {file ? file.name : 'Fayl seçmək üçün tıkla'}
          </span>
          <span className="text-xs text-ink-faint">.csv və ya .xlsx — maks. 10 MB</span>
        </button>
        <input
          ref={inputRef}
          type="file"
        ...
        <input
          ...
          placeholder="Mənbə adı (opsional)"
